          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              >
                ...
                <span className="block text-indigo-600 xl:inline">Your School</span>
              </motion.h1>
              <motion.p
              ...
              >
                Empowering minds, inspiring futures. Join us in our journey of academic excellence and personal growth.
              </motion.p>
